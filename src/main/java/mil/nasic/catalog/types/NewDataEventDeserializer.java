...
public class NewDataEventDeserializer extends JsonDeserializer<NewDataEvent> {

    @Override
    public NewDataEvent deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
            throws IOException {
        ...
        NewDataEvent nde = new NewDataEvent();
        nde.setCatalog(rec);
        return nde;
    }
}